...
module.exports = {
    ...
    booksAll: function(req, res) {
        ...
        ModelBooks.allBooks(limit, page, function(err, rows, results, fields, numItems) {
            if (err) throw err;

            ModelBooks.numePagesBooks(function(err, rows) {

                numRows = rows[0].numRows
            })

            console.log(ModelBooks.numePagesBooks(rows))
