...
routes.post('/login', (req, res) => {
    ...
    conn.query('SELECT * FROM users WHERE name = ? AND password = ?', [req.body.email, req.body.password,], (err, rows) => {

        console.log(rows)

        // if( email === result.body.email && password === result.body.password){
        //     const tokenData = {
        //         email: email
        //       // ANY DATA
        //     }
